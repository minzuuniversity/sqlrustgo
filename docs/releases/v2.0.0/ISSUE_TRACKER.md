...
| Issue | 标题 | 状态 |
|-------|------|------|
| #944 | Phase 3: 分布式能力 - Sharding/分布式事务 | **OPEN** ⚠️ |
...
| Issue | 标题 | 状态 |
|-------|------|------|
| #946 | Phase 5: 性能优化 - 向量化/CBO/列式存储 | **OPEN** ⚠️ |
...
| Issue | 标题 | 原因 |
|-------|------|------|
| #941 | v2.0.0 开发总控 | 测试覆盖率不足 (28.88%→需60%+) |
| #944 | Phase 3: 分布式能力 | 覆盖率仅9.2%，分区/分布式查询未完成 |
| #946 | Phase 5: 性能优化 | 向量化/CBO 未完成验收标准 |
| #758 | Parquet 导入导出 | COPY语句集成测试覆盖率0% |
